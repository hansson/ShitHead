...
public class GameActivity extends GCMActivity {
    ...
    private final List<Card> mPlay = new LinkedList<Card>();
    private ImageView mTurnChip = null;
    private ImageView[] mRibbons = null;
    private final int mRibbonDrawables[] = {R.drawable.ribbon_1, R.drawable.ribbon_2, R.drawable.ribbon_3};
    ...
    private int[] getNameImageValues(int playerIndex, int usernameLength, int textSize) {
        ...
        switch (playerIndex) {
            case 0:
                //LEFT
                return new int[]{30, (textSize / 2) * usernameLength, -90, -((textSize / 2) * usernameLength), 30};
            case 1:
                //TOP
                return new int[]{(textSize / 2) * usernameLength, 30, 0, 0, 30};
            case 2:
                //RIGHT
                return new int[]{30, (textSize / 2) * usernameLength, 90, 0, 0};
            default:
